...
%%     \usebeamertemplate*{title separator}
    ...
    \begin{frame}[label=current]{Обзор существующих решений: Bazel}
        \begin{itemize}
    ...
    \begin{frame}[label=current]{Обзор существующих решений: make --shuffle}
        \begin{itemize}
    ...
    \begin{frame}[label=current]{Теоретический метод: Гонка на пути к файлу}
    ...
    \begin{frame}[label=current]{Теоретический метод: Гонка на каталоге}
    ...
    \begin{frame}[label=current]{Реализация: Перехват системных вызовов}
        \begin{center}
