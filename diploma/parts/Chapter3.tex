...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \node[style=draw, rounded corners, minimum width=3cm] (lib1) at (8.75,2) {\texttt{dir\_lookup(build)}};

        \node at (3.75,1) {...};
        \node at (7.75,1) {...};

        \node[style=draw, rounded corners, minimum width=3cm] (lib9build) at (3.75,0) {\texttt{mkdir(build)}};
        \node[style=draw, rounded corners, minimum width=3cm] (lib9) at (8.75,0) {\texttt{dir\_lookup(build)}};
        ...
        \node[style=draw, rounded corners, minimum width=3cm] (lib10) at (8.75,-1) {\texttt{dir\_lookup(build)}};
