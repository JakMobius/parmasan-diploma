...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \node[font=\small] (text1) at (6.7, -2) {События ptrace};
        \node[font=\small] (text1) at (1, -2) {События над файлами и процессами};
        \node[font=\small] (text2) at (3.5, 1.8) {Соответствие процессов целям и граф зависимостей};
    \end{tikzpicture}
